...
public class Push extends AbstractPush{
	...
	public IAdvice createAdvice( long adviceId, IAdvice.AdviceTypes type, String member, String text, String icon, String badge, int repeat) {
		return new Advice( super.getSubscriptionId(), adviceId, member, type, text, icon, badge, repeat );
	}
}
